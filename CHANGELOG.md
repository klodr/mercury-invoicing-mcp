...
## [0.17.0](https://github.com/klodr/mercury-invoicing-mcp/compare/v0.16.1...v0.17.0) (2026-05-13)


### ⚠ BREAKING CHANGES

* address audit findings (simplify + security + architecture)

### Added

* auto-detect sandbox tokens (mercury_sandbox_*) → api-sandbox URL ([1eadac9](https://github.com/klodr/mercury-invoicing-mcp/commit/1eadac95ac293b3f2cac98e654f249d41acdc77e))
* **codecov:** wire Test Analytics (JUnit + test-results-action) ([#78](https://github.com/klodr/mercury-invoicing-mcp/issues/78)) ([61b05d2](https://github.com/klodr/mercury-invoicing-mcp/commit/61b05d2f102ef032b167d64bd8ec1319e413ea0e))
* complete API coverage — 23 new tools (total: 45) ([1b4d03c](https://github.com/klodr/mercury-invoicing-mcp/commit/1b4d03c7227a114e85ca28609ac1695dfb6271d8))
* **docker:** Dockerfile + icon for MCP Registry submission ([#56](https://github.com/klodr/mercury-invoicing-mcp/issues/56)) ([0458738](https://github.com/klodr/mercury-invoicing-mcp/commit/0458738058c22bbd87a8b0160234fa7dbdac0e9d))
* dual-window rate limits (daily + 30d rolling monthly) ([#49](https://github.com/klodr/mercury-invoicing-mcp/issues/49)) ([ae564b3](https://github.com/klodr/mercury-invoicing-mcp/commit/ae564b34f137ca1ecbd1e465ec8962d6d65d914d))
* implement all banking + AR invoicing tools (Phase 3 + 4) ([cbcad88](https://github.com/klodr/mercury-invoicing-mcp/commit/cbcad88000b1aa1a2d84eeb95074d1ca92d6cf7f))
* **prompts:** slash commands for Mercury recipe workflows ([#82](https://github.com/klodr/mercury-invoicing-mcp/issues/82)) ([8a6425c](https://github.com/klodr/mercury-invoicing-mcp/commit/8a6425cef51af42cc1bbe97a75d3eaad1323aba1))
* **rate-limit:** split create_internal_transfer into its own 5/day category ([c5ef630](https://github.com/klodr/mercury-invoicing-mcp/commit/c5ef6307c51146791e26bf6839d1fa41607224f4))
* **rate-limit:** tighten defaults ([e8141ba](https://github.com/klodr/mercury-invoicing-mcp/commit/e8141ba295f997f83efc7dc8bb542027f0893025))
* rattrapage Mercury API endpoints (32 → 34 tools) ([91f6fc5](https://github.com/klodr/mercury-invoicing-mcp/commit/91f6fc52812e94cdb69e78ac9f05c97c59cedca3))
* **release:** sign + attach SPDX + CycloneDX SBOMs to each release ([#60](https://github.com/klodr/mercury-invoicing-mcp/issues/60)) ([fc1f4e1](https://github.com/klodr/mercury-invoicing-mcp/commit/fc1f4e133aade4392048b75cc7e6c9ab57215932))
* **scorecard:** add fast-check fuzz tests and SLSA .intoto.jsonl ([#19](https://github.com/klodr/mercury-invoicing-mcp/issues/19)) ([2c54498](https://github.com/klodr/mercury-invoicing-mcp/commit/2c544986302b38602e1915d439c30675a9bc777e))
...
* **security:** rate limiting + dry-run + audit log middleware ([f45f050](https://github.com/klodr/mercury-invoicing-mcp/commit/f45f0500ba28959fd3f71a753f4d4ded959806c3))
* Snyk badge in README + Sigstore signing of release artifacts ([#13](https://github.com/klodr/mercury-invoicing-mcp/issues/13)) ([23205c7](https://github.com/klodr/mercury-invoicing-mcp/commit/23205c7b79aac3e2f7e8b4528d2f09f9fc95cf6a))
* support Mercury sandbox via MERCURY_API_BASE_URL env ([bd6427e](https://github.com/klodr/mercury-invoicing-mcp/commit/bd6427ed4deb5855e54d79e826d58959a96a2d17))
* **tools:** add MCP annotations to all 36 tools ([#97](https://github.com/klodr/mercury-invoicing-mcp/issues/97)) ([df1f67e](https://github.com/klodr/mercury-invoicing-mcp/commit/df1f67e3d6cd0f65f1a5b46a8a16922b4f6cbf8f))
* **tools:** declare openWorldHint:true on every tool ([#181](https://github.com/klodr/mercury-invoicing-mcp/issues/181)) ([947b2a9](https://github.com/klodr/mercury-invoicing-mcp/commit/947b2a9d3ea1dddd1f49580a53182e559215c8a6))


### Fixed

* **build:** remove duplicate shebang + docs: add OpenClaw setup section ([fc12f5e](https://github.com/klodr/mercury-invoicing-mcp/commit/fc12f5ea8a1233666d98146ff35a5d39fc95e58a))
* **ci:** add top-level permissions: contents: read to auto-merge ([#183](https://github.com/klodr/mercury-invoicing-mcp/issues/183)) ([3f1ab05](https://github.com/klodr/mercury-invoicing-mcp/commit/3f1ab058280df839a1ddc46295d3cccc7c653a61))
...
* **ci:** pin ossf/scorecard-action to v2.4.3 ([#7](https://github.com/klodr/mercury-invoicing-mcp/issues/7)) ([cbf8bcc](https://github.com/klodr/mercury-invoicing-mcp/commit/cbf8bcc2bc3b466d5cd899ec3b0ee45dfc51f81a))
...
* **ci:** use the actual commit SHA of v4.35.2, not the tag-object SHA ([#28](https://github.com/klodr/mercury-invoicing-mcp/issues/28)) ([4d4f7a8](https://github.com/klodr/mercury-invoicing-mcp/commit/4d4f7a8bfcf5e46e7a1dbb351ee6b25cd347911e))
* **customers:** require 'name' field in address schema ([2d4d152](https://github.com/klodr/mercury-invoicing-mcp/commit/2d4d1525295854e4d7bec3640df8a02cb385a11a))
* **deps:** downgrade zod to ^3.25.76 (SDK MCP requires zod 3) ([8a3ddcb](https://github.com/klodr/mercury-invoicing-mcp/commit/8a3ddcb24e24f52f11cd7a090f72a1956b436e52))
* **deps:** override test-exclude (not glob) to keep coverage working ([df9a3ea](https://github.com/klodr/mercury-invoicing-mcp/commit/df9a3ea5f5c07b5ce27d3c338c00e42f24b05c38))
* invoice line item schema, update endpoint, simplify findings ([26e6234](https://github.com/klodr/mercury-invoicing-mcp/commit/26e6234e232a8bee59ff70680b5b10be4a7f449a))
* **invoices:** enforce Mercury text-field limits in Zod (lineItem.name 200, invoiceNumber 255) ([#11](https://github.com/klodr/mercury-invoicing-mcp/issues/11)) ([1277fb0](https://github.com/klodr/mercury-invoicing-mcp/commit/1277fb0a9c6a3ed00c4207d77e19002b9d71c187))
...
* **middleware:** persist rate-limit state across process restarts (v0.7.4) ([#30](https://github.com/klodr/mercury-invoicing-mcp/issues/30)) ([5a74de4](https://github.com/klodr/mercury-invoicing-mcp/commit/5a74de42ba90d98640f73da6beb14f8f5d472c05))
* **middleware:** prevent audit throws from masking errors (Qodo) ([#80](https://github.com/klodr/mercury-invoicing-mcp/issues/80)) ([84568e7](https://github.com/klodr/mercury-invoicing-mcp/commit/84568e7cf0b29d9bbeee8d25383889514ba37398))
* **node18:** import randomUUID from node:crypto ([badef2f](https://github.com/klodr/mercury-invoicing-mcp/commit/badef2fd3ff8e8747ec219e57bb3fb0a80422ae7))
* **output:** stripControl on JSON values + fence errors (M-02 ping-pong) ([#69](https://github.com/klodr/mercury-invoicing-mcp/issues/69)) ([c7fc812](https://github.com/klodr/mercury-invoicing-mcp/commit/c7fc8120b1869aef35430fc4a298bd1c94007895))
...
* **readme:** remove Socket Security badge until npm publish ([#8](https://github.com/klodr/mercury-invoicing-mcp/issues/8)) ([93333dc](https://github.com/klodr/mercury-invoicing-mcp/commit/93333dc928630c863db9cf18e874ed0586d55ad0))
* **release:** replace wrong @sigstore/cli@1.0.0 with actions/attest-b… ([#15](https://github.com/klodr/mercury-invoicing-mcp/issues/15)) ([9e841df](https://github.com/klodr/mercury-invoicing-mcp/commit/9e841df203e359b8941540801c88778c0cdd4ce9))
* remove tools that don't exist in Mercury's public API ([d5ee990](https://github.com/klodr/mercury-invoicing-mcp/commit/d5ee99056e09a81b99d62407a61833dd6ccaf532))
* **sanitize:** spell control-char regex with \uXXXX escapes (CodeQL [#28](https://github.com/klodr/mercury-invoicing-mcp/issues/28)) ([#75](https://github.com/klodr/mercury-invoicing-mcp/issues/75)) ([8054ccf](https://github.com/klodr/mercury-invoicing-mcp/commit/8054ccf3f2aaa1d060ed00bafd3187bd5cf39852))
...
* **security:** 0.8.6 — republish 0.8.5 without personal emails ([#67](https://github.com/klodr/mercury-invoicing-mcp/issues/67)) ([ba2d6ed](https://github.com/klodr/mercury-invoicing-mcp/commit/ba2d6ed8b02a7fcc09f5bcd6347bedc49811378b))
* **security:** apply .uuid() validation to categoryId in update_transaction (L1) ([dd81408](https://github.com/klodr/mercury-invoicing-mcp/commit/dd81408d0811b84aee9105497b1608522656f676))
* **security:** fetch timeout (SEC-009) and dev-only sourcemaps (SEC-010) ([adb77fb](https://github.com/klodr/mercury-invoicing-mcp/commit/adb77fbe78c309e1616be3d24b65dee5c8f008ec))
* **security:** pin Actions by SHA, .uuid()+encodeURIComponent, strict sandbox match ([f0a4061](https://github.com/klodr/mercury-invoicing-mcp/commit/f0a406101852d2324ff2962a73c0d5071926040c))
* **server:** validate MERCURY_API_BASE_URL override (SSRF defense) ([#98](https://github.com/klodr/mercury-invoicing-mcp/issues/98)) ([8249992](https://github.com/klodr/mercury-invoicing-mcp/commit/82499922fe3c58049562275bbc458fefb818530c))
* **verify-release:** drop --signer-workflow (mutually exclusive with --cert-identity) ([#36](https://github.com/klodr/mercury-invoicing-mcp/issues/36)) ([07d1cd3](https://github.com/klodr/mercury-invoicing-mcp/commit/07d1cd31495b5afb4a485a88ee64df43f65188fc))
* **verify-release:** pin cosign predicate to SLSA Provenance v1 ([#180](https://github.com/klodr/mercury-invoicing-mcp/issues/180)) ([8889485](https://github.com/klodr/mercury-invoicing-mcp/commit/88894859a8a638c3891b4450e2e87e5436cf6d1c))
* **webhooks:** enforce HTTPS + block private IPs on webhook URL (M-01) ([#68](https://github.com/klodr/mercury-invoicing-mcp/issues/68)) ([0ab18e7](https://github.com/klodr/mercury-invoicing-mcp/commit/0ab18e7b5505b54787cb65ee5f2f141d69c31d3c))


### Changed

* **.github:** add social-preview.png asset (1280×640) ([#91](https://github.com/klodr/mercury-invoicing-mcp/issues/91)) ([c7113ae](https://github.com/klodr/mercury-invoicing-mcp/commit/c7113ae44095d15b8e5a7899bc73379feee30b04))
...
* add CodeRabbit configuration ([87116fc](https://github.com/klodr/mercury-invoicing-mcp/commit/87116fc7e42f7cb00d6b8df99b5cbfae035ddebb))
...
* add explicit CodeQL Advanced workflow (SAST 0 → 10 in Scorecard) ([c455b40](https://github.com/klodr/mercury-invoicing-mcp/commit/c455b40d9a7b1a399d5face56829e6921f561b48))
...
* add npm publish workflow + publishing documentation ([3aca2e8](https://github.com/klodr/mercury-invoicing-mcp/commit/3aca2e8809aa2bea1297f9174e588f7f88a67f77))
...
* add workflow_dispatch trigger to release-please ([#112](https://github.com/klodr/mercury-invoicing-mcp/issues/112)) ([523b63f](https://github.com/klodr/mercury-invoicing-mcp/commit/523b63f484d58921f84accfcb95abae80e4c9214))
...
* address audit findings (simplify + security + architecture) ([10f25b2](https://github.com/klodr/mercury-invoicing-mcp/commit/10f25b2fc524adf0fccc7155f66d56fd55db7564))
* align config files (eslint header, eqeqeq style, tsup sourcemap) ([#90](https://github.com/klodr/mercury-invoicing-mcp/issues/90)) ([3e8afc4](https://github.com/klodr/mercury-invoicing-mcp/commit/3e8afc4a3e2bd8d96062f029c5754b3ed4ad7b5f))
* backport editorconfig/gitleaks/lockfile-lint/osv-scanner ([#113](https://github.com/klodr/mercury-invoicing-mcp/issues/113)) ([3c23cef](https://github.com/klodr/mercury-invoicing-mcp/commit/3c23cef755a2d5be50502d2f67836613d037938b))
* bump actions/checkout from 4 to 6 ([#1](https://github.com/klodr/mercury-invoicing-mcp/issues/1)) ([e984e89](https://github.com/klodr/mercury-invoicing-mcp/commit/e984e89c9268998984d78d0fa4c59bc5d55aaa7e))
* bump actions/setup-node from 4 to 6 ([#2](https://github.com/klodr/mercury-invoicing-mcp/issues/2)) ([a6acdbf](https://github.com/klodr/mercury-invoicing-mcp/commit/a6acdbff96339cd34b476e7fdff9918d827bdc8e))
* bump actions/setup-node from 6.3.0 to 6.4.0 ([#41](https://github.com/klodr/mercury-invoicing-mcp/issues/41)) ([5dbd284](https://github.com/klodr/mercury-invoicing-mcp/commit/5dbd284d5b8d34e85291c0e30c2998afe1d5bac4))
* bump codecov/codecov-action from 5 to 6 ([#3](https://github.com/klodr/mercury-invoicing-mcp/issues/3)) ([2e305fa](https://github.com/klodr/mercury-invoicing-mcp/commit/2e305fa7259f92af0dffa440eb09e65349ad0aac))
...
* bump github/codeql-action from 4.35.2 to 4.35.3 ([#105](https://github.com/klodr/mercury-invoicing-mcp/issues/105)) ([ed5d940](https://github.com/klodr/mercury-invoicing-mcp/commit/ed5d940c13983fc0eff909620ce88ba1267538f6))
...
* bump the dev-dependencies group with 3 updates ([#54](https://github.com/klodr/mercury-invoicing-mcp/issues/54)) ([6944538](https://github.com/klodr/mercury-invoicing-mcp/commit/6944538a3a3e74ee1be39cf30987731cff0e0c16))
* **bundle-analysis:** add codecov-bundle.json for OIDC upload ([#114](https://github.com/klodr/mercury-invoicing-mcp/issues/114)) ([28ff749](https://github.com/klodr/mercury-invoicing-mcp/commit/28ff74962ad54e16b44c167e0a7bc2c6c99b7720))
...
* **codecov:** allow no-upload PRs to pass status checks ([#43](https://github.com/klodr/mercury-invoicing-mcp/issues/43)) ([cfa125b](https://github.com/klodr/mercury-invoicing-mcp/commit/cfa125b0a499ac740d7eccea52b4ed030df41882))
* **codecov:** make only_pulls: false explicit ([#116](https://github.com/klodr/mercury-invoicing-mcp/issues/116)) ([be8b2be](https://github.com/klodr/mercury-invoicing-mcp/commit/be8b2be4a6c6513dcb24f5e6d28b44694cdb3582))
* **codecov:** revert project threshold to 0.5% (post-v0.8.0 baseline) ([#38](https://github.com/klodr/mercury-invoicing-mcp/issues/38)) ([f1d350b](https://github.com/klodr/mercury-invoicing-mcp/commit/f1d350bd7eca44491a5d44268e24a8f3f57203c9))
...
* **codecov:** strip inline comments from codecov.yml ([#117](https://github.com/klodr/mercury-invoicing-mcp/issues/117)) ([a9402fb](https://github.com/klodr/mercury-invoicing-mcp/commit/a9402fb888f0c186273d57d6b9c9bbbad6e5bb21))
...
* **coverage:** rename istanbul ignore → v8 ignore ([#77](https://github.com/klodr/mercury-invoicing-mcp/issues/77)) ([7a39266](https://github.com/klodr/mercury-invoicing-mcp/commit/7a39266ce8aba69bc52e1c3df8e20c3a9afa5348))
* **dependabot:** ignore @types/node major + parity limit ([#53](https://github.com/klodr/mercury-invoicing-mcp/issues/53)) ([8d0bd6b](https://github.com/klodr/mercury-invoicing-mcp/commit/8d0bd6b197c94c797ca3a7e7596b94c28801f9fe))
...
* **deps-dev:** bump eslint 10.3.0 + typescript-eslint 8.59.1 ([#102](https://github.com/klodr/mercury-invoicing-mcp/issues/102)) ([92e0589](https://github.com/klodr/mercury-invoicing-mcp/commit/92e058913e9d2331de7ffe84d7f0141810601329))
...
* **deps:** bump Node floor to &gt;=22.22 (22.22.2 CVEs) ([#85](https://github.com/klodr/mercury-invoicing-mcp/issues/85)) ([5a81415](https://github.com/klodr/mercury-invoicing-mcp/commit/5a814152f534cee820d3790df5787d537bfc60ee))
* **deps:** bump zod 4.3.6 → 4.4.2 ([#103](https://github.com/klodr/mercury-invoicing-mcp/issues/103)) ([38a2b54](https://github.com/klodr/mercury-invoicing-mcp/commit/38a2b54e751fb307c8d5efe419e9f54cf5172d1a))
...
* **deps:** bump zod in the production-dependencies group ([#5](https://github.com/klodr/mercury-invoicing-mcp/issues/5)) ([85e122a](https://github.com/klodr/mercury-invoicing-mcp/commit/85e122adc794fbfd6f35c03f8cc5c6c21b0e353b))
* **deps:** jest 29 → 30 + glob override to drop deprecated transitives ([8e67290](https://github.com/klodr/mercury-invoicing-mcp/commit/8e672900d91110c4ed9a1ef4634bbc6958159c9b))
* **deps:** pin Node floor to exact &gt;=22.22.2 (CVE fixes) ([#86](https://github.com/klodr/mercury-invoicing-mcp/issues/86)) ([954c7cc](https://github.com/klodr/mercury-invoicing-mcp/commit/954c7cc1b4973d415923e5209a5f358e6c4d4ed3))
* **docker:** HEALTHCHECK NONE on stdio image to silence Checkov ([#61](https://github.com/klodr/mercury-invoicing-mcp/issues/61)) ([a58d072](https://github.com/klodr/mercury-invoicing-mcp/commit/a58d072125f97cb00b11c919076d0335ec3a04a7))
* enable codecov OIDC upload for Dependabot context ([#108](https://github.com/klodr/mercury-invoicing-mcp/issues/108)) ([14d8ee7](https://github.com/klodr/mercury-invoicing-mcp/commit/14d8ee749310ec09b56b57f0d9cf00d1463d31ce))
...
* extract createServer to enable testing (96% coverage) ([d02c7ee](https://github.com/klodr/mercury-invoicing-mcp/commit/d02c7ee09048905c543c111f1951ab4f325a4527))
...
* **glama:** claim ownership on glama.ai via glama.json ([#74](https://github.com/klodr/mercury-invoicing-mcp/issues/74)) ([604b562](https://github.com/klodr/mercury-invoicing-mcp/commit/604b562fdfeb0e891ffd944052dab9f647641624))
* **hardening:** close LOW/INFO findings from security review ([#99](https://github.com/klodr/mercury-invoicing-mcp/issues/99)) ([7d09b2f](https://github.com/klodr/mercury-invoicing-mcp/commit/7d09b2fcbaf832fcf14ca5249deab48dff41178d))
...
* **leak-detect:** re-pin reusable workflow to fix yq checksum SHA ([#178](https://github.com/klodr/mercury-invoicing-mcp/issues/178)) ([a82f869](https://github.com/klodr/mercury-invoicing-mcp/commit/a82f8694cc219121b2f9795e6e7af1100d0033cb))
...
* **lint:** adopt eslint-plugin-unicorn (pass 1) ([#185](https://github.com/klodr/mercury-invoicing-mcp/issues/185)) ([50c8d08](https://github.com/klodr/mercury-invoicing-mcp/commit/50c8d08af1026730c3c5d4143251fc911476a748))
* **lint:** enable prevent-abbreviations with klodr/* allowList ([#188](https://github.com/klodr/mercury-invoicing-mcp/issues/188)) ([df07999](https://github.com/klodr/mercury-invoicing-mcp/commit/df079999229b7a4dbb99485389d97c5503c3b266))
* **lint:** reactivate 6 markdownlint rules previously disabled ([#179](https://github.com/klodr/mercury-invoicing-mcp/issues/179)) ([a463100](https://github.com/klodr/mercury-invoicing-mcp/commit/a4631001ff8f95ad9c76914eb6de1e19b0c34501))
* **lint:** tighten unicorn policy to match faxdrop (6 disables) ([#186](https://github.com/klodr/mercury-invoicing-mcp/issues/186)) ([c7cb1e7](https://github.com/klodr/mercury-invoicing-mcp/commit/c7cb1e7f872ab366a45ff1fc4c9411c66f7adc38))
...
* **lockfile-lint:** pin install by sha512 hash ([#115](https://github.com/klodr/mercury-invoicing-mcp/issues/115)) ([dbdd500](https://github.com/klodr/mercury-invoicing-mcp/commit/dbdd5009830761e2d36adaae92282ff7c189fb70))
...
* **main:** release 0.14.1 ([#111](https://github.com/klodr/mercury-invoicing-mcp/issues/111)) ([14e2d4d](https://github.com/klodr/mercury-invoicing-mcp/commit/14e2d4db4d3796a49c2276b4ff3153ee723e74ef))
* **main:** release 0.15.0 ([#120](https://github.com/klodr/mercury-invoicing-mcp/issues/120)) ([01a33aa](https://github.com/klodr/mercury-invoicing-mcp/commit/01a33aa309100f75c33e22f1079680214da6a726))
* **main:** release 0.15.1 ([#131](https://github.com/klodr/mercury-invoicing-mcp/issues/131)) ([0c27639](https://github.com/klodr/mercury-invoicing-mcp/commit/0c276393e7c44816fde718690aa279d6a91650c6))
* **main:** release 0.15.2 ([#134](https://github.com/klodr/mercury-invoicing-mcp/issues/134)) ([8b84f01](https://github.com/klodr/mercury-invoicing-mcp/commit/8b84f01de61a1c353012294971ab6adb0c75186b))
* **main:** release 0.15.3 ([#139](https://github.com/klodr/mercury-invoicing-mcp/issues/139)) ([fee58ab](https://github.com/klodr/mercury-invoicing-mcp/commit/fee58ab969947caf56dd7eaa62f9a91f51a8f1ff))
* **main:** release 0.15.4 ([#145](https://github.com/klodr/mercury-invoicing-mcp/issues/145)) ([fc932ac](https://github.com/klodr/mercury-invoicing-mcp/commit/fc932acb8c94cc7623640bb9e6358e34b3a73601))
* **main:** release 0.15.5 ([#162](https://github.com/klodr/mercury-invoicing-mcp/issues/162)) ([1ce5c2d](https://github.com/klodr/mercury-invoicing-mcp/commit/1ce5c2d402b609f6548db5f0ac179afed65cb4bd))
* **main:** release 0.15.6 ([#167](https://github.com/klodr/mercury-invoicing-mcp/issues/167)) ([8b16e70](https://github.com/klodr/mercury-invoicing-mcp/commit/8b16e70e6ea19557e685950f28310916fbc84ec9))
* **main:** release 0.15.7 ([#177](https://github.com/klodr/mercury-invoicing-mcp/issues/177)) ([2cc0ccc](https://github.com/klodr/mercury-invoicing-mcp/commit/2cc0ccca82660a022a02ba25495c9199ed919d59))
* **main:** release 0.16.0 ([#182](https://github.com/klodr/mercury-invoicing-mcp/issues/182)) ([76bff25](https://github.com/klodr/mercury-invoicing-mcp/commit/76bff25499747435854ec5e9efffa50cc4022fe2))
* **main:** release 0.16.1 ([#184](https://github.com/klodr/mercury-invoicing-mcp/issues/184)) ([f4c1981](https://github.com/klodr/mercury-invoicing-mcp/commit/f4c1981e8cfe6907293f9992fa6f53046c509913))
...
* migrate release-please for automated version bumps ([#110](https://github.com/klodr/mercury-invoicing-mcp/issues/110)) ([dcf86b5](https://github.com/klodr/mercury-invoicing-mcp/commit/dcf86b50fdf0f5a0db12f32fff63c5eb3737d1a0))
...
* **node:** bump floor to Node 22 (Active LTS) ([#72](https://github.com/klodr/mercury-invoicing-mcp/issues/72)) ([2b0b209](https://github.com/klodr/mercury-invoicing-mcp/commit/2b0b209777f98ebb51c00de7d6e9b87b4a1f0f82))
* **node:** tighten engines floor to &gt;=22.11 ([#76](https://github.com/klodr/mercury-invoicing-mcp/issues/76)) ([40efb04](https://github.com/klodr/mercury-invoicing-mcp/commit/40efb04c76e720f7ef027c2a1c263a3b80b45eef))
* pin packageManager field to npm@11.12.1 ([#93](https://github.com/klodr/mercury-invoicing-mcp/issues/93)) ([399aade](https://github.com/klodr/mercury-invoicing-mcp/commit/399aadebdc8fa759ebd79e22ae6ddc0120ec5e5a))
...
* **qodo:** add dual reviewer (DeepSeek R1 + Gemini 3.1) via Qodo Merge ([#70](https://github.com/klodr/mercury-invoicing-mcp/issues/70)) ([0461b94](https://github.com/klodr/mercury-invoicing-mcp/commit/0461b9401d1e0202c786fbbc0c3c4d8c1de1d34a))
* release v0.15.0 ([#118](https://github.com/klodr/mercury-invoicing-mcp/issues/118)) ([15e8bc8](https://github.com/klodr/mercury-invoicing-mcp/commit/15e8bc862c064afdf926209bb744a7e8d54250be))
...
* **release:** 0.3.0 ([87f5cd7](https://github.com/klodr/mercury-invoicing-mcp/commit/87f5cd70804924dee3664b4b0d8e16931068735d))
* **release:** 0.4.0 ([7e9a133](https://github.com/klodr/mercury-invoicing-mcp/commit/7e9a133fa96ca0d4f21d4adfb2f54b8f89ca709c))
* **release:** 0.5.0 ([#12](https://github.com/klodr/mercury-invoicing-mcp/issues/12)) ([570f4fb](https://github.com/klodr/mercury-invoicing-mcp/commit/570f4fbb0c0d9dd23a7a9d1f81514a0c72edf643))
* **release:** 0.6.1 ([#16](https://github.com/klodr/mercury-invoicing-mcp/issues/16)) ([398d53d](https://github.com/klodr/mercury-invoicing-mcp/commit/398d53dc595373d5e1f10a2e04f766131cb985af))
* **release:** 0.6.2 ([#18](https://github.com/klodr/mercury-invoicing-mcp/issues/18)) ([059c603](https://github.com/klodr/mercury-invoicing-mcp/commit/059c603ff9d31ac5c2d6dd0e3910ffb368560052))
* **release:** 0.7.0 ([#20](https://github.com/klodr/mercury-invoicing-mcp/issues/20)) ([c1ae941](https://github.com/klodr/mercury-invoicing-mcp/commit/c1ae941267c6e37b2fec56a2be8372111cba1124))
* **release:** 0.7.1 ([#23](https://github.com/klodr/mercury-invoicing-mcp/issues/23)) ([6cf3272](https://github.com/klodr/mercury-invoicing-mcp/commit/6cf3272e41e9788053303d2fa5a523dac226c874))
* **release:** 0.7.2 ([#27](https://github.com/klodr/mercury-invoicing-mcp/issues/27)) ([1798427](https://github.com/klodr/mercury-invoicing-mcp/commit/1798427f2ce20ce55c2f162e731aca9d0182636a))
* **release:** 0.7.3 ([#29](https://github.com/klodr/mercury-invoicing-mcp/issues/29)) ([2d76e64](https://github.com/klodr/mercury-invoicing-mcp/commit/2d76e64b5686aff265b21bb92aa4587bdaca2ffd))
* **release:** 0.8.4 ([#64](https://github.com/klodr/mercury-invoicing-mcp/issues/64)) ([4e13900](https://github.com/klodr/mercury-invoicing-mcp/commit/4e1390077207788d252182919583cf34b4050cbe))
* **release:** 0.8.5 ([#65](https://github.com/klodr/mercury-invoicing-mcp/issues/65)) ([8032566](https://github.com/klodr/mercury-invoicing-mcp/commit/8032566a71e0b737a50cb23fe8c7f10a5e69c05c))
* **release:** 0.9.2 ([#79](https://github.com/klodr/mercury-invoicing-mcp/issues/79)) ([24bc2b1](https://github.com/klodr/mercury-invoicing-mcp/commit/24bc2b18aad8c04bfa7cabc858e23a4d7cd4fedf))
* **release:** bump version to 0.2.0 ([4c2536c](https://github.com/klodr/mercury-invoicing-mcp/commit/4c2536cd2170bec6c8565aff453348370099e0c6))
...
* **release:** v0.10.0 ([#87](https://github.com/klodr/mercury-invoicing-mcp/issues/87)) ([63fc7b5](https://github.com/klodr/mercury-invoicing-mcp/commit/63fc7b517c4604088c03d15e91e4130ba2859dbd))
* **release:** v0.11.0 ([#92](https://github.com/klodr/mercury-invoicing-mcp/issues/92)) ([7838e25](https://github.com/klodr/mercury-invoicing-mcp/commit/7838e25fcfb236d736069ff47b5285ae083030be))
* **release:** v0.12.0 ([#96](https://github.com/klodr/mercury-invoicing-mcp/issues/96)) ([80738e8](https://github.com/klodr/mercury-invoicing-mcp/commit/80738e81f348bf7ce47ee8f1c396ed5da973c555))
* **release:** v0.14.0 — dependency refresh ([#104](https://github.com/klodr/mercury-invoicing-mcp/issues/104)) ([1f3c983](https://github.com/klodr/mercury-invoicing-mcp/commit/1f3c983cbebb0a45d9d90264369ff18f6bd5f7fd))
* **release:** v0.7.9 — verify-release CLI flag fix ([#37](https://github.com/klodr/mercury-invoicing-mcp/issues/37)) ([0008d3d](https://github.com/klodr/mercury-invoicing-mcp/commit/0008d3d97f6a9b2456a8b5a48ad50bac8d88b587))
* **release:** v0.9.0 (external reviewer + M-01/M-02 fixes) ([#71](https://github.com/klodr/mercury-invoicing-mcp/issues/71)) ([af52b21](https://github.com/klodr/mercury-invoicing-mcp/commit/af52b211071cadca96225f6d31899ad3bae642cb))
* **release:** v0.9.1 (Node 22 migration) ([#73](https://github.com/klodr/mercury-invoicing-mcp/issues/73)) ([67b90df](https://github.com/klodr/mercury-invoicing-mcp/commit/67b90df47afede85459916773fac3cded21d0f29))
* **roadmap:** Node.js 22 migration deadline 2026-04-30 ([#62](https://github.com/klodr/mercury-invoicing-mcp/issues/62)) ([a1e0654](https://github.com/klodr/mercury-invoicing-mcp/commit/a1e065450e12d4afae9cf7e721bab9c434e6f002))
...
* single-source the version in package.json ([c1310e2](https://github.com/klodr/mercury-invoicing-mcp/commit/c1310e20ccf042e097a97a1fb17de6debe4a4244))
* **socket:** add socket.yml to acknowledge legitimate behavior + upstream-deps alerts ([ba4eedc](https://github.com/klodr/mercury-invoicing-mcp/commit/ba4eedc4b7ed5edfd0eb9ae2bf238184ccdc8c71))
* **socket:** silence intrinsic-behavior alerts (false instead of true) ([#39](https://github.com/klodr/mercury-invoicing-mcp/issues/39)) ([52a12e3](https://github.com/klodr/mercury-invoicing-mcp/commit/52a12e3f9b0f89944a10d2bb5348936665dd00d5))
...
* **verify-release:** add --cert-identity for exact SAN match (v0.7.6) ([#32](https://github.com/klodr/mercury-invoicing-mcp/issues/32)) ([e7e642b](https://github.com/klodr/mercury-invoicing-mcp/commit/e7e642b3541e5af5ebc5ac81e8370b6d18b5ef55))
* **verify-release:** manual ECDSA verify of npm registry signature (v0.7.8) ([#34](https://github.com/klodr/mercury-invoicing-mcp/issues/34)) ([3db77d3](https://github.com/klodr/mercury-invoicing-mcp/commit/3db77d35af5a11e0132e73cf83f5e85def33c415))
* **verify-release:** pin npm install by tarball SHA-1 (v0.7.7) ([#33](https://github.com/klodr/mercury-invoicing-mcp/issues/33)) ([158cbfd](https://github.com/klodr/mercury-invoicing-mcp/commit/158cbfd99c61159e503885dba1563ae375e0eac0))
...
* add CodeRabbit Pull Request Reviews badge ([#46](https://github.com/klodr/mercury-invoicing-mcp/issues/46)) ([e6c3b44](https://github.com/klodr/mercury-invoicing-mcp/commit/e6c3b44054dbc5d2a5b657222b655e58e699a1e6))
* add llms-install.md for assistant-driven install ([#45](https://github.com/klodr/mercury-invoicing-mcp/issues/45)) ([beb13ac](https://github.com/klodr/mercury-invoicing-mcp/commit/beb13acf696870b79496b7dbdc483395e9d4156c))
* better send_invoice workaround — download PDF + email manually ([58d98a9](https://github.com/klodr/mercury-invoicing-mcp/commit/58d98a9751039e396019c426cbee98131ac3c0e0))
* **contributing:** one-line DCO reference ([#59](https://github.com/klodr/mercury-invoicing-mcp/issues/59)) ([e3ca015](https://github.com/klodr/mercury-invoicing-mcp/commit/e3ca0156ab3971067f3b46b0d6bd90b37d33291a))
* correct IO Credit endpoints — they are documented ([#88](https://github.com/klodr/mercury-invoicing-mcp/issues/88)) ([2654c92](https://github.com/klodr/mercury-invoicing-mcp/commit/2654c921ab41f52551d7eb89f154b8407a03b0e5))
* correct send_invoice claim — it doesn't exist anywhere, not even in the dashboard ([2f0d477](https://github.com/klodr/mercury-invoicing-mcp/commit/2f0d4772c515f18c659355cc1465a412635c7646))
* expand the Contributing section with a PR checklist ([#9](https://github.com/klodr/mercury-invoicing-mcp/issues/9)) ([a24bfca](https://github.com/klodr/mercury-invoicing-mcp/commit/a24bfca79ea53d21e1b1fa31f389ea0a6aef943a))
* move Contributing section to CONTRIBUTING.md ([#47](https://github.com/klodr/mercury-invoicing-mcp/issues/47)) ([d4cd233](https://github.com/klodr/mercury-invoicing-mcp/commit/d4cd233b5f4f9000436b041a61681be9488ea570))
* move Roadmap to ROADMAP.md + consolidate Silver wording ([#57](https://github.com/klodr/mercury-invoicing-mcp/issues/57)) ([5cbe1cb](https://github.com/klodr/mercury-invoicing-mcp/commit/5cbe1cb8e4d360484e3aaaeca202ab164f09c310))
* post-audit cleanup (CHANGELOG dedup, README transparency, sandbox-test) ([127f1b5](https://github.com/klodr/mercury-invoicing-mcp/commit/127f1b596392b513a9f0edd5a795e9f48744c77b))
* **readme:** add MCP Server badge from badge.mcpx.dev ([#44](https://github.com/klodr/mercury-invoicing-mcp/issues/44)) ([96b35ee](https://github.com/klodr/mercury-invoicing-mcp/commit/96b35ee44f61f614f811d660637cdafb89d7c10d))
* **readme:** drop redundant MIT license badge ([#94](https://github.com/klodr/mercury-invoicing-mcp/issues/94)) ([31d8e85](https://github.com/klodr/mercury-invoicing-mcp/commit/31d8e851ff388c0a8ecf500df73e60189a53b91e))
* **readme:** emoji-tag headings (Docker MCP style) ([#84](https://github.com/klodr/mercury-invoicing-mcp/issues/84)) ([83c7acb](https://github.com/klodr/mercury-invoicing-mcp/commit/83c7acb9e34f47eca98e6676da7b2641c475ffad))
* **readme:** enrich the 'Why this MCP?' comparison table ([5750b3f](https://github.com/klodr/mercury-invoicing-mcp/commit/5750b3fd5be790f73951979c02606699a39f450b))
* **readme:** trim 'Why this MCP?' table to 10 actually-differentiating rows ([02d333d](https://github.com/klodr/mercury-invoicing-mcp/commit/02d333d4be097922d1b1b65f2e738edf05e5e514))
...
* reorganize community files + add SUPPORT/CITATION ([#89](https://github.com/klodr/mercury-invoicing-mcp/issues/89)) ([260db9c](https://github.com/klodr/mercury-invoicing-mcp/commit/260db9ca01656e9cc55d585163f3811afb419149))
* **roadmap:** add Docker MCP Registry as discoverability target ([#101](https://github.com/klodr/mercury-invoicing-mcp/issues/101)) ([4580064](https://github.com/klodr/mercury-invoicing-mcp/commit/45800649b0a8d296a3c29237798e663ef767854e))
* **roadmap:** IO Credit account + invoice automatic reminders ([#81](https://github.com/klodr/mercury-invoicing-mcp/issues/81)) ([658b87d](https://github.com/klodr/mercury-invoicing-mcp/commit/658b87dcff8a9e4bab4a734c1bcc7da2fe797db0))
* **security:** describe dual-window rate limits ([#50](https://github.com/klodr/mercury-invoicing-mcp/issues/50)) ([d8b3ea3](https://github.com/klodr/mercury-invoicing-mcp/commit/d8b3ea341636743f56f3b342dad4d200308e1eff))
* **security:** use --bundle &lt;.sigstore&gt; for cosign verify-blob-attes… ([#21](https://github.com/klodr/mercury-invoicing-mcp/issues/21)) ([62aaf12](https://github.com/klodr/mercury-invoicing-mcp/commit/62aaf1292ab1c36d52a83121e058e57e399a384c))
* **silver:** add Roadmap section and CODE_OF_CONDUCT.md ([#55](https://github.com/klodr/mercury-invoicing-mcp/issues/55)) ([dd813fe](https://github.com/klodr/mercury-invoicing-mcp/commit/dd813fed50cb21d02fe22abf243ffb7d8995ebe6))
* **tools:** adopt TDQS pattern for all 36 tool descriptions ([#95](https://github.com/klodr/mercury-invoicing-mcp/issues/95)) ([6ee1f77](https://github.com/klodr/mercury-invoicing-mcp/commit/6ee1f77686ed7bc9f6e1d8d9d36cbb7ac605eac4))
* update CHANGELOG for v0.1.0 release ([aaa5eed](https://github.com/klodr/mercury-invoicing-mcp/commit/aaa5eed4be1986161cd30e051b5f5b95705d17c2))
* update README + CHANGELOG to reflect 45 tools ([a2a6e07](https://github.com/klodr/mercury-invoicing-mcp/commit/a2a6e07554be517440081a41271b47ca4fa2b420))
